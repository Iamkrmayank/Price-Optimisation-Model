...
if selected_tab == 'Today':
    ...
    if not filtered_df.empty:
        ...
        # Price range sliders
        min_price, max_price = st.slider("Select Price Range", float(filtered_df['MRP'].min()), float(filtered_df['MSP'].max()), (float(filtered_df['MRP'].min()), float(filtered_df['MSP'].max())))
